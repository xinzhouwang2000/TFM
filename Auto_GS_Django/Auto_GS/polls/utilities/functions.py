...
def insert_data(data):
    ...
    session.execute(
        """
        INSERT INTO example_dataview (example_dataview_sequence_number, 
        dummy_telecommand__myinteger_payload, dummy_telecommand__myinteger_timestamp, 
        dummy_telemetry__myinteger_payload, dummy_telemetry__myinteger_timestamp)
        VALUES (%s, %s, %s, %s, %s)
        """,
        (data['example_dataview_sequence_number'], data['dummy_telecommand__myinteger_payload'],
        data['dummy_telecommand__myinteger_timestamp'], data['dummy_telemetry__myinteger_payload'],data['dummy_telemetry__myinteger_timestamp'])
    )
...
def select_by(table, key, value):
    try:
        ...
        #Escribido así para evitar inyección
